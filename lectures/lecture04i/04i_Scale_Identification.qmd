...
```{r, include=FALSE}
if (length(grep(pattern = "lecture04i.RData", x = dir()))  == 0){
  system("Rscript 04i_Scale_Identification.R")
}

load("lecture04i.RData")
...
* Lognormal SD is $\sqrt{ \left[ \exp \left( \sigma^2 \right) -1 \right] \exp \left(2\mu + \sigma^2 \right) }  = 54.1$
