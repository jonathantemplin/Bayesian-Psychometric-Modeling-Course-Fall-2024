...
if (length(grep(dir(), pattern = "lecture03c.RData")) == 0){
  source("03c_Bayesian_Model_Fit_and_Comparisons.R")
}

model06.samples = readRDS("model06_samples.RDS")
model07.samples = readRDS("model07_samples.RDS")
