...
* I like to say "math don't care" to describe how a mathematical model is agnostic to the context in which it is used
...
* Latent variables can have different levels of measurement (hypothetically)
...
* The CFA model assumes (1) continuous latent and (2) continuous observed variables
...
- Note: there is no error variance term...why?
:::
