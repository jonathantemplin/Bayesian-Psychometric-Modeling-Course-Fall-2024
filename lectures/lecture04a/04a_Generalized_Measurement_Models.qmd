...
$$ 
f(E\left(Y_{p1} \mid \boldsymbol{\theta}_p\right) ) = \mu_1 + q_{11}\left( \lambda_{11} \theta_{p1} \right) + q_{12}\left( \lambda_{12} \theta_{p2} \right) = \mu_1 + \boldsymbol{\lambda}_{1} \text{diag}\left(\boldsymbol{q}_i \right) \boldsymbol{\theta}_p^T
$$
...
## Identification of Latent Traits, Part 3
