...
if (length(grep(pattern = "lecture04d.RData", x = dir()))  == 0){
  system("Rscript 04d_Modeling_Observed_Polytomous_Data.R")
}
...
$$P\left(Y_{i{c_i}} = c_i \mid \theta \right) = 
P^*\left(Y_{i{c_i} } \geq c_i-1 \mid \theta \right) - P^*\left(Y_{i{c_i}} \geq c_i \mid \theta \right) 
$$
