...
Model 3: Using Stan, reestimate model 2 but with empirical priors on the factor loadings and on the item intercept parameters. Use the z-score method of identification, in which each factor mean is fixed to 0, each factor variance is fixed to 1, and all factor correlations are estimated.
