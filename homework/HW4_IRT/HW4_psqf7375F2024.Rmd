...
**6. What would you predict would happen to the latent variables if you were to use an empirical prior (as in section 2)?** 

**My Answer**

**9. Provide a scatter plot of the EAP estimates of the latent variables ($\theta_p$) (x-axis) and the posterior standard deviation estimates of the latent variables (y-axis)** 
